...
Date::DATE_FORMATS[:human] = "%B %e, %Y" # November 3, 2013
...
DateTime::DATE_FORMATS[:human] = "%B %e, %Y" # November 3, 2013 14:22
...
Time::DATE_FORMATS[:human] = "%B %d, %Y %H:%M"           # November 3, 2013 14:22
