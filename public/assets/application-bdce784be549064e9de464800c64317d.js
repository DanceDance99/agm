...
(function() {
  ...
  jQuery(function() {
    jQuery('.new_booking').on('change', '#booking_passengers, #booking_from_id, #booking_to_id, #booking_round_trip_true', function(e) {
      var shuttle_id;
      shuttle_id = jQuery('#booking_modal_button').data('shuttle-id');
      if (jQuery('#booking_from_id').val() && jQuery('#booking_to_id').val()) {
        ...
        return jQuery.post("/shuttles/" + shuttle_id + "/bookings/dates", jQuery('.new_booking').serialize(), function(e) {
          jQuery('#depart_date_datepicker').datepicker({
            defaultDate: '',
            altFormat: "yy-mm-dd",
            altField: '#depart_date_hidden_datepicker',
            beforeShowDay: function(date) {
              var date_str, date_utc;
            ...
            return $("#depart_date_hidden_datepicker").val(selected_date);
          });
          return jQuery('#return_date_datepicker').datepicker({
            defaultDate: '',
            altFormat: "yy-mm-dd",
            ...
            selected_date = $.datepicker.formatDate("yy-mm-dd", selected_date);
            return $("#return_date_hidden_datepicker").val(selected_date);
          });
        });
      }
    });
    return jQuery('.new_booking').on('change', '#booking_round_trip_true, #booking_round_trip_false', function(e) {
      return jQuery('#return_date_datepicker').toggle(jQuery('[name=booking\\[round_trip\\]]:checked').val() === 'true');
    });
  });
