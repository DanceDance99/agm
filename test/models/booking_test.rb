...
class BookingTest < ActiveSupport::TestCase
  ...
  test "booking should be valid" do
    valid_attributes = {:shuttle => shuttles(:one), :to => shuttle_cities(:one), :from => shuttle_cities(:two), :depart_date => Date.today, :passengers => 1, :added_by_admin => true, :email_address => 'example@msn.com', :telephone_number => '0000000000'}
